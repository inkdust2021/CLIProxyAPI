...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/fatal-auth-enabled", s.mgmt.GetFatalAuthEnabled)
		mgmt.PUT("/fatal-auth-enabled", s.mgmt.PutFatalAuthEnabled)
		mgmt.PATCH("/fatal-auth-enabled", s.mgmt.PutFatalAuthEnabled)
		mgmt.GET("/fatal-auth-action", s.mgmt.GetFatalAuthAction)
		mgmt.PUT("/fatal-auth-action", s.mgmt.PutFatalAuthAction)
		mgmt.PATCH("/fatal-auth-action", s.mgmt.PutFatalAuthAction)
